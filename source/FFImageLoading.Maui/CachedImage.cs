	...
	public class CachedImage : View
	{
		...
		protected static bool IsDesignModeEnabled
		{
			get
			{
				...
				{
					var type = typeof(Image).GetTypeInfo().Assembly.GetType("Microsoft.Maui.Controls.DesignMode");
					if (type == null)
					{
		...
		private static readonly PropertyInfo _visualMarkerProperty = typeof(VisualElement).GetTypeInfo().Assembly.GetType("Microsoft.Maui.Controls.VisualMarker")?.GetRuntimeProperty("Default");
